                        ...
                        <div>
                            <Link to={""} className="group">
                                <div className="w-full h-[250px] relative">
                                    ...
                                    <h3 className="text-lg lg:text-xl font-semibold main2Color bg-white px-3 lg:px-4 py-2 lg:py-3 absolute left-0 bottom-0 group-hover:bg-[#29abe2] group-hover:text-white w-[90%]">বেগম রোকেয়া বিশ্ববিদ্যালয়ের নতুন ওয়েবসাইটে উদ্বোধন</h3>
                                </div>
                            </Link>
                        </div>
                    </div>
